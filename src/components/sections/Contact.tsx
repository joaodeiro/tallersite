...
const EMAIL = "jordano@taller.net.br";
...
const Contact = () => {
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    const mailtoLink = `mailto:${EMAIL}?subject=Novo contato via site&body=` +
      encodeURIComponent(
        ...
        `Aceita receber comunicações: ${formData.get('terms') ? 'Sim' : 'Não'}`
      );
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-16">
          ...
          <div className="ai-card bg-[#1e1e1e] border border-[#222222]">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <Button type="submit" variant="cta" className="w-full">Enviar mensagem</Button>
            </form>
          </div>
        </div>
      </div>
